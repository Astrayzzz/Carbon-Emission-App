...
st.header("การพยากรณ์ค่าคาร์บอน")
st.markdown("กราฟนี้แสดงแนวโน้มการปล่อยคาร์บอนทั้งหมดที่พยากรณ์ล่วงหน้า 30 วัน")
...
st.markdown("ทดลองวางแผนการขนส่งของคุณ")
